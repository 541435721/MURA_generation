#! /usr/bin/env python
# -*- coding: utf-8 -*-
# @File  : normal_GAN_2_modified_2.py
# @Author: Xuesheng Bian
# @Email: xbc0809@gmail.com
# @Date  : 2018/7/2 18:07
# @Desc  : increase channels of generator
...
if __name__ == '__main__':
    ...
    summary = tensorboardX.SummaryWriter('./normal_GAN_log_2_modified_2')
    for epoch in range(500):
        ...
        torch.save(G.state_dict(), 'params_G_2_modified_2.pkl')
        torch.save(D.state_dict(), 'params_D_2_modified_2.pkl')
    summary.close()
