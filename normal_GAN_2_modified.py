...
if __name__ == '__main__':
    ...
    summary = tensorboardX.SummaryWriter('./normal_GAN_log_2_modified')
    for epoch in range(500):
        ...
        torch.save(G.state_dict(), 'params_G_2_modified.pkl')
        torch.save(D.state_dict(), 'params_D_2_modified.pkl')
    summary.close()
