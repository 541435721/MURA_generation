...
if __name__ == '__main__':
    ...
    D = Discriminator(1, 1, 3, 1)

    G_Optim = Adam(G.parameters(), 0.00002, betas=(0.5, 0.999))
    D_Optim = Adam(D.parameters(), 0.00002, betas=(0.5, 0.999))
    ...
    data = np.load('x_ray_resized_equal.npy')[:, np.newaxis, ...] / 255 * 2 - 1
    summary = tensorboardX.SummaryWriter('./normal_GAN_log')
    for epoch in range(5000):
        ...
        torch.save(D.state_dict(), 'params_D.pkl')
    summary.close()
