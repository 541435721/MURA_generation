#! /usr/bin/env python
# -*- coding: utf-8 -*-
# @File  : normal_GAN_for_CT_5.py
# @Author: Xuesheng Bian
# @Email: xbc0809@gmail.com
# @Date  : 2018/7/5 19:00
# @Desc  : train D more times than G
...
if __name__ == '__main__':
    ...
    summary = tensorboardX.SummaryWriter('./normal_GAN_for_CT_5')
    for epoch in range(5000):
        ...
        torch.save(G.state_dict(), 'params_G_normal_GAN_for_CT_5.pkl')
        torch.save(D.state_dict(), 'params_D_normal_GAN_for_CT_5.pkl')
    summary.close()
