...
if __name__ == '__main__':
    ...
    G_Optim_scheduler = lr_scheduler.StepLR(G_Optim, step_size=10, gamma=0.99)
    D_Optim_scheduler = lr_scheduler.StepLR(D_Optim, step_size=10, gamma=0.99)
    ...
    summary = tensorboardX.SummaryWriter('./normal_GAN_log_4')
    for epoch in range(500):
        ...
        torch.save(G.state_dict(), 'params_G_4.pkl')
        torch.save(D.state_dict(), 'params_D_4.pkl')
    summary.close()
